                              ...
                              <?php $total = 0 ?>
                                 ...
                                 <tr class="woocommerce-cart-form__cart-item cart_item">
                                    ...
                                    <td class="product-remove">
                                       <a onclick="removecart(<?php echo e($id); ?>)" class="remove" aria-label="Remove Baked Potato Pizza from cart" data-product_id="5389" data-product_sku="">×</a>
                                    </td>

                                    <td class="product-thumbnail">
                                       <a href="<?php echo e($url_link); ?>"><img width="300" height="300" src="<?php echo e($details['image_thumb'] ?? $details['image']); ?>" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" decoding="async" fetchpriority="high"></a>
                                    </td>
                                    ...
                                    <td class="product-price" data-title="Price">
                                       <span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">$</span><?php echo e(isset($details['price']) && $details['price'] > 0 ? number_format($details['price']) : __('Contact')); ?></bdi></span>
                                    </td>

                                    <td class="product-quantity" data-title="Quantity">
                                       <div class="quantity">
                                          <label class="screen-reader-text" for="quantity_66012ede6838a"> <?php echo e(isset($details['price']) && $details['price'] > 0 ? number_format($details['price']) : __('Contact')); ?></label>
                                 ...
                                 <tr>
                                    <td colspan="6" class="actions">
                                       ...
                                       <a class="button" href="<?php echo e(url()->current()); ?>" >Update cart</a>
                              ...
                              <table cellspacing="0" class="shop_table shop_table_responsive">
                                 ...
                                 <tbody>
                                    <tr class="cart-subtotal">
                                       <th>Subtotal</th>
                                       <td data-title="Subtotal"><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">$</span><?php echo e(number_format($total)); ?></bdi></span></td>
                                    </tr>
                                    ...
                                    <tr class="order-total">
                                       <th>Total</th>
                                       <td data-title="Total"><strong><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">$</span><?php echo e(number_format($total)); ?></bdi></span></strong> </td>
                                    </tr>
   ...
   </html><?php /**PATH D:\xampp\htdocs\restaurant\resources\views/frontend/pages/cart/index.blade.php ENDPATH**/ ?>