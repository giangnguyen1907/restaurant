   ...
   <div class="menu-main-menu-container">
      ...
      <?php foreach($menu as $item){
         ...
         <li id="menu-item-13" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home current-menu-ancestor current-menu-parent menu-item-has-children menu-item-13">
            <a href="<?php echo e($item->url_link); ?>"><?php echo e($item->name); ?></a>
            <ul class="sub-menu">
                            <?php
...
</div><?php /**PATH D:\xampp\htdocs\restaurant\resources\views/frontend/element/menu_mobile.blade.php ENDPATH**/ ?>