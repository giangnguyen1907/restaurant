...
<section
	...
	<div id="jarallax-container-1"
		...
		<img class="jarallax-img"
			src="{{ asset('themes/frontend/home_files/images/asian-assorted-food-set-ERZSHTC-1.jpg')}}"
					...
					<div class="elementor-widget-container">
						<div class="ppb_portfolio one nopadding "
							...
							<div class="page_content_wrapper fullwidth">
								...
								@foreach($menunoibat as $key => $menus)
											...
											<div id="portfolio_desc_3190"
												...
												<div
													...
													<div id="menu_3190"
														...
														<h5
															class="menu_post">
															<span class="menu_title"> {{ $menus->title }}</span>
														</h5>
														<div
															class="post_detail menu_excerpt">{{ $menus->mota }}</div>
														<br class="clear">
														<br>
														<span
															class="menu_price">
															{{ $menus->gia }} <?php if($menus->donvitien=='Dollar') echo '$'; else echo $menus->donvitien ?></span>
													</div>
												</div>
											</div>
