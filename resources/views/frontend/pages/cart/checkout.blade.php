                                    ...
                                    <table class="shop_table woocommerce-checkout-review-order-table">
                                        ...
                                        @php $total = 0 @endphp
                                            ...
                                            <tr class="cart_item">
                                                ...
                                                <td class="product-name">
                                                   {{ $details['title'] }}&nbsp; <strong class="product-quantity">×&nbsp;{{ $details['quantity'] }}</strong>
                                                    <dl class="variation">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr class="cart-subtotal">
                                                <th>Subtotal</th>
                                                <td><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">$</span>{{ number_format($total) }}</bdi></span></td>
                                            </tr>
